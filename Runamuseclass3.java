...
public class Runamuseclass3 {
	...
	public void calage(String customeridnumber) {
	...
	public void calnight(int discountselect, int ordercount) {
		int price = 0;
		if (discountselect == 1) {
